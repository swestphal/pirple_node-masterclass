...
workers.validateCheckData = function (originalCheckData) {
    ...
    originalCheckData.userPhone = typeof (originalCheckData.userPhone) == 'string' && originalCheckData.userPhone.trim().length >= 5 ? originalCheckData.userPhone.trim() : false;
